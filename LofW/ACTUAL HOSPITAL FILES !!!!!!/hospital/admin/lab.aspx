...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_main" Runat="Server">
    ...
    <br />
     ...
     <div id="pagingControls"></div>
                    ...
                    <br />
                    <asp:Label ID="patientcodeI" Text="Patient Code" runat="server" /> <br />
                    ...
                    <br />      
                    <asp:Label ID="lbl_dobI" Text="Date of Birth" runat="server" /> <br />
           ...
           <asp:RegularExpressionValidator ID="rev_sexI" runat="server" ControlToValidate="txt_sexI" ValidationExpression="^[a-zA-Z ]*$"  />
                    ...
                    <br />
                    <asp:Label ID="lbl_testCodeI" Text="Test Code" runat="server" /> <br />
                    <asp:TextBox ID="txt_testCodeI" runat="server"  />
                    <br />
                    <asp:Label ID="lbl_result1I" Text="Result A" runat="server" />  <br />
                    <asp:TextBox ID="txt_result1I" runat="server"  />
                    <br />
                    <asp:Label ID="lbl_result2I" Text="Result B" runat="server" />   <br />    
                    <asp:TextBox ID="txt_result2I" runat="server"  />
                    <br />
                    <asp:Label ID="lbl_resultDescI" Text="Result Description" runat="server" /> <br />
                    <asp:TextBox ID="txt_resultDescI" runat="server"  />
                    <br />
                    <asp:Label ID="lbl_abnormalI" Text="Abnormalities" runat="server" /> <br />
                    <asp:TextBox ID="txt_abnormalI" runat="server"  />
                    <br />
                    <asp:Label ID="lbl_refrangeI" Text="Reference Range" runat="server" /> <br />
