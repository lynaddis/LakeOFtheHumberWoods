...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_main" Runat="Server">
    ...
    <asp:LoginView ID="log_view" runat="server" >
        ...
        <br /> <br /> <br />
        <%-- Displays a list of invoice associated with the user for them to select to view more details   --%>
        ...
        <%-- upon selecting an invoice from the gridview above didplays the details of the invoice where users can decide to either pay it or print it  --%>
        ...
        <%-- Hidden fields used to pass data values to paypal --%>
        ...
        <asp:Label ID="test" runat="server" />
            ...
            <%-- Paypal button; on click will send invoice data to paypal from code behinde --%>
