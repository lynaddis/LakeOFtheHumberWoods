...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void subInsert(object sender, CommandEventArgs e)
    {
        ...
        {
            case "Insert":
                _strMessage(objContact.commitInsert(txt_fname.Text, txt_lname.Text, int.Parse(txt_tel.Text.ToString()),txt_email.Text.ToString(),txt_subject.Text.ToString(),txt_message.Text.ToString()), "insert");
                 break;
            case "Cancel":
                break;
        }
